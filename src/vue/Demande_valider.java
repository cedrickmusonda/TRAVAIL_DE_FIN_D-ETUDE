...
public class Demande_valider extends javax.swing.JFrame {
      public void search() {
       TableRowSorter< TableModel> trier = new TableRowSorter<>(tabdemandevalider.getModel()) ;
       tabdemandevalider.setRowSorter(trier);
    ...
    public Demande_valider() {
        ...
        // masquer les panels non autoriser
       ...
       tabdemandevalider.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD,14));
       tabdemandevalider.getTableHeader().setOpaque(false);
       tabdemandevalider.getTableHeader().setBackground(new Color(0,102,170));
       tabdemandevalider.getTableHeader().setForeground(new Color(255,255,255 ));
       tabdemandevalider.setRowHeight(25);
       // afficher les demandes valide
        MesMethodes methode=new MesMethodes();
        try {
              //afficher les demandes dans le tableau
              ResultSet resulta= methode.Afficherdemandevalide(Recupere.getId_agent(),"Validee");
              tabdemandevalider.setModel(DbUtils.resultSetToTableModel(resulta));   
              //afficher les nombre de demande
            ResultSet result=methode.NombreDemandevalider(Recupere.getId_agent(),"Validee");
            while( result.next()){
         ...
         //appel de la methode pour la recherce de demande
         search();
    ...
    private void initComponents() {
        ...
        tabdemandevalider = new javax.swing.JTable();
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(nombredemande, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(16, 16, 16))
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(nombredemande, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        tabdemandevalider.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        tabdemandevalider.setForeground(new java.awt.Color(0, 0, 0));
        tabdemandevalider.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabdemandevalider.setDoubleBuffered(true);
        tabdemandevalider.setSelectionBackground(new java.awt.Color(252, 57, 95));
        tabdemandevalider.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tabdemandevalider);
  ...
  // fermeture de la fenetre
   ...
   // se deconnecter
    ...
    private javax.swing.JTable tabdemandevalider;
