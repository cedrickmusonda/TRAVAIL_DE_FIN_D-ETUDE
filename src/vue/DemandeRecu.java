 ...
 * @author Cedrick
 */
public class DemandeRecu extends javax.swing.JFrame {

    /**
     * Creates new form DemandeRecu
     */
    public DemandeRecu() {
        initComponents();
       jTable1.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD,14));
       jTable1.getTableHeader().setOpaque(false);
       jTable1.getTableHeader().setBackground(new Color(0,102,170));
    ...
    private void initComponents() {
        ...
        PaneldemandeRecu.setBackground(new java.awt.Color(0, 102, 170));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom du visiteur", "Post-nom du visiteur", "Prénom du visiteur", "Département", "Etat de la Demande"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DemandeRecu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
