...
public class mes_demandes extends javax.swing.JFrame {
    
       public void search() {
       TableRowSorter< TableModel> trier = new TableRowSorter<>(Tableau_demande.getModel()) ;
       Tableau_demande.setRowSorter(trier);
       nom_demande.getDocument().addDocumentListener(new DocumentListener(){
           @Override
           public void insertUpdate(DocumentEvent e) {
         String str = nom_demande.getText();
  ...
  public mes_demandes() {
        initComponents();
// masquer la le panel demande envoyer et recu en fonction des utilisateurs
...
// mise en forme du tableau
       Tableau_demande.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD,14));
       Tableau_demande.getTableHeader().setOpaque(false);
       Tableau_demande.getTableHeader().setBackground(new Color(0,102,170));
       Tableau_demande.getTableHeader().setForeground(new Color(255,255,255 ));
       Tableau_demande.setRowHeight(25);
//affichage de demandes
 MesMethodes methode=new MesMethodes();
        try {
              //afficher les demandes dans le tableau
              ResultSet resulta= methode.Afficherlesdemandes(Recupere.getId_agent());
              Tableau_demande.setModel(DbUtils.resultSetToTableModel(resulta));   
              //afficher les nombre de demande
            ResultSet result=methode.NombreDemandes(Recupere.getId_agent());
            while( result.next()){
            nombredemande.setText(result.getString("nombre"));
  ...
  // recherche de demandes par le nom
    search();
  // afficher l'utilisateur connecter
  jLabel3.setText(Recupere.getNomutilisateur());
    ...
    private void initComponents() {
        ...
        nombredemande = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        Tableau_demande = new javax.swing.JTable();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(Panelenvoye, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        nom_demande.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.white, java.awt.Color.white));

        recherche.setBackground(new java.awt.Color(0, 102, 170));
        recherche.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vue/recherch.png"))); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addComponent(nom_demande, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(recherche, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        nombredemande.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        nombredemande.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(nombredemande, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(nombredemande, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        Tableau_demande.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        Tableau_demande.setForeground(new java.awt.Color(0, 0, 0));
        Tableau_demande.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Nom du visiteur", "Post-nom du visiteur", "Prénom du visiteur", "Département", "Etat"
            }
        ));
        Tableau_demande.setDoubleBuffered(true);
        Tableau_demande.setSelectionBackground(new java.awt.Color(252, 57, 95));
        Tableau_demande.getTableHeader().setResizingAllowed(false);
        Tableau_demande.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(Tableau_demande);

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 102, 170));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mes_demandes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable Tableau_demande;
    ...
    private javax.swing.JLabel nombredemande;
